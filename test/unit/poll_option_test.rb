...
class PollOptionTest < Test::Unit::TestCase
  ...
  def test_invalid_too_long
    poll_option = PollOption.new(
      :description => "012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789")
    assert poll_option.valid?
    poll_option = PollOption.new(
      :description => "012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789x")
    assert !poll_option.valid?
