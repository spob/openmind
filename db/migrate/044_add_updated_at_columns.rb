class AddUpdatedAtColumns < ActiveRecord::Migration
  def self.up
    ...
    add_column :poll_user_responses, :updated_at, :datetime, :null => true
    ...
    add_column :watches, :updated_at, :datetime, :null => true
    ...
    execute "update poll_user_responses set updated_at = now() where updated_at is null"
    ...
    execute "update watches set updated_at = now() where updated_at is null"
    ...
    change_column :poll_user_responses, :updated_at, :datetime, :null => false
    ...
    change_column :watches, :updated_at, :datetime, :null => false
  end
  ...
  def self.down
    ...
    remove_column :poll_user_responses, :updated_at
    ...
    remove_column :watches, :updated_at
  end
end
